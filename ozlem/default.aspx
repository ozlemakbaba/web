<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ozlem._default" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>Les coin des freelancers</title>

        <!-- Bootstrap Core CSS -->
        <link href="Accueil/bootstrap/css/bootstrap.min.css" rel="stylesheet"/>

        <!-- Font Awesome CSS -->
        <link href="Accueil/css/font-awesome.min.css" rel="stylesheet">
		
		<!-- Custom CSS -->
        <link href="Accueil/css/animate.css" rel="stylesheet">
        ...
        <!-- Template js -->
        <script src="Accueil/js/jquery-2.1.1.min.js"></script>
        <script src="Accueil/bootstrap/js/bootstrap.min.js"></script>
        <script src="Accueil/js/jquery.appear.js"></script>
        <script src="Accueil/js/contact_me.js"></script>
        <script src="Accueil/js/jqBootstrapValidation.js"></script>
        <script src="Accueil/js/modernizr.custom.js"></script>
        <script src="Accueil/js/script.js"></script>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            ...
                            <span><asp:Label runat="server" ID="label1" /></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="menu-item blue">
                            <a href="Accueil/Authentification.aspx">
                        ...
                        <div class="menu-item green">
                            <a href="Accueil/Registration.aspx">
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="padding-bottom: 30px;">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="Accueil/images/about-03.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="Accueil/images/about-02.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="Accueil/images/about-01.jpg" class="img-responsive" alt="">
                                    </div>
        ...
        <div class="copyright text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>Design & Developed by Mouad Afathi & Ghada Aqil </div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/1.png" class="img-responsive" alt="...">
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/2.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/3.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/4.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/5.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/6.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/7.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/8.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/9.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/10.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/11.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="Accueil/images/portfolio/12.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/manage-1.png" class="img-responsive" alt="">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/manage-2.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/manage-3.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/manage-4.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/team-1.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/team-2.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/team-3.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="Accueil/images/team/team-4.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="Accueil/images/blog-01.jpg" class="img-responsive" alt="">
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="Accueil/images/blog-02.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="Accueil/images/blog-03.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="Accueil/images/blog-04.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
